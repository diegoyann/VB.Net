		...
		Try
			With cliente
				...
				Else
					...
					Else
						sql = "Insert Into TbCliente (Nome,Nascimento,Sexo,Cpf,Rg,Logradouro,Numero,Complemento,Cep,Bairro,Cidade,Uf,TelefoneResidencial,Celular)" +
							"Values (@nome,@nascimento,@sexo,@cpf,@rg,@logradouro,@nrCasa,@complemento,@cep,@bairro,@cidade,@uf,@residencial,@celular)"
						con.Command.CommandText = "Insert Into tbcliente (Saldo,Cpf) values (@saldo,@cpf)"
